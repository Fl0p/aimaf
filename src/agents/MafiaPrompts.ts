...
export const DEFAULT_PROMPTS = {
  root: `Write concise messages under 100 words. Do not use markdown, formatting, bold, italics, or emojis. Use plain text only. Be direct and clear. Do not add your name to the message, it will be added automatically. When referring to player names, use @ before their name (e.g., @PlayerName). When using tools, provide player names as plain text without @ symbol.`,
